export const superAdminCreationEmailTemplate = ({
  email,
  password,
  redirect_link,
  recovery_link
...
<body style="margin: 0 !important; padding: 0 !important; background-color: #f4f4f4;">
    ...
    <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
        You've been added as one of the super admins for Travel Buddy.
    </div>
                                ...
                                <tr>
                                    <td style="padding: 40px 30px; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; color: #555555;">
                                        ...
                                        <h3>Important next steps:</h3>
                                          <ol>
                                            <li>
                                              Visit the <a href=${redirect_link}>Admin Portal</a> to log in
                                            </li>
                                            <li>
                                              Change your password immediately by <a href="${recovery_link}">following this link</a>
                                            </li>
                                            <li>
                                              Start creating and managing your experiences
                                            </li>
                                          </ol>`}
                                        ${!password && `<p style="margin: 0 0 15px;">For security reasons, if you have not changed your password after your first login, we recommend <a href="${recovery_link}">changing your password</a>.</p>`}
                                </tr>
                            </table>
                        </td>
                    </tr>
...
export const superAdminUpdateEmailTemplate = ({
  companyName,
  redirect_link
}: {
  companyName: string;
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Your Super Admin profile has been updated in ${companyName}.</title>
    <style type="text/css">
        /* Basic Resets */
        body, table, td, a { -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; }
        table, td { mso-table-lspace: 0pt; mso-table-rspace: 0pt; }
...
<body style="margin: 0 !important; padding: 0 !important; background-color: #f4f4f4;">
    ...
    <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
        Your Super Admin profile has been updated on Travel Buddy 8.
    </div>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" align="center" style="margin: 0 auto;">
                                            <tr>
                                                <td align="center" style="border-radius: 5px; background-color: #007bff;">
                                                    ...
                                                    >
                                                        Click Here to Login and Start Managing
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
