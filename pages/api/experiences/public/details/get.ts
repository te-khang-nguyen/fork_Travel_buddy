...
export const swaggerPublicExpDetailsGet = {
    index:14, 
    text:
`"/api/v1/experiences/public/details": {
      "get": {
        "tags": ["experience"],
        "summary": "Get destination details for a non-authenticated user",
        "description": "Retrieve destination details by destination ID and optional type for a non-authenticated user.",
        "parameters": [
          {
            "in": "query",
            "name": "experience-id",
