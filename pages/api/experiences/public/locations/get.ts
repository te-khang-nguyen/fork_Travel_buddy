...
export const swaggerPublicLocationGet = {
    index:16, 
    text:
`"/api/v1/experiences/public/locations": {
      "get": {
        "tags": ["experience"],
        "summary": "Get locations by destination ID for a non-authenticated user",
        "description": "Retrieve locations by destination ID for a non-authenticated user.",
        "parameters": [
          {
            "in": "query",
            "name": "experience-id",
