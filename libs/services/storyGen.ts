...
async function generateLocationStories(
    ...
    2. Detect the locations within the [Tour Notes] using [Tour Locations] and highlight detected locations – They’re the star! Don’t miss any key details from this section.
    ...
    4. Prioritize detected locations from [Tour Notes]. Use [Tour Schedule] as reference for correct order of paragraph. 
